...
export default function TafiDelValle() {
    return (
        <div className="bg-color-3" style={{ height: "100vh" }}>
            ...
            <div className="d-flex justify-content-center py-4 bg-color-3">
                <h2 className="mb-0 text-white">RUTA DEL ARTESANO - TAFI DEL VALLE</h2>
            </div>
            <div className='bg-color-1 text-center mb-5'>
                <div className='position-relative'>
                    <img src={"/img/actividades/planos/artesanotafi.jpg"} style={{ width: "1080px", height: "auto" }} alt="" />
                </div>
            </div>
