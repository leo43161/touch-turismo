...
export default function valles() {
    return (
        <div style={{ backgroundColor: "#ABA693" }}>
            ...
            <div className="text-center pt-3 text-black d-flex px-4">
                <div className="py-2 px-3" style={{ backgroundColor: "#BA007D" }}>
                    <h2 className="mb-0 text-white">CIRCUITO VALLES CALCHAQUIES</h2>
                </div>
            </div>
            <div>
                <div className="position-relative px-4 pt-3">
                    <img src="/img/mapas/mapas_valles.png" className="img-fluid" alt="" />
                </div>
                <div className="d-flex justify-content-end mt-3">
                    <div className="col-3 mb-3">
                        <img className="img-fluid col-11" src="/img/mapas/qr_valles.png" alt="" />
                    </div>
                </div>
